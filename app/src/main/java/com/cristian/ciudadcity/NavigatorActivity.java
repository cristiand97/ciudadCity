...
import com.cristian.ciudadcity.fragment.EditFragment;
import com.cristian.ciudadcity.fragment.InicioFragment;
import com.cristian.ciudadcity.fragment.MostrarFragment;
...
public class NavigatorActivity extends AppCompatActivity
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_inicio) {
            ...
            mAuth.signOut();
            Intent inte = new Intent(NavigatorActivity.this,MainActivity.class);
            startActivity(inte);
            finish();
        }
